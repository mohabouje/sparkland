...
namespace spl::reflect {
    ...
    template <>
    struct identifier<spl::protocol::coinbase::websocket::public_stream::subscribe::request> {
        using value_type                = spl::protocol::coinbase::websocket::public_stream::subscribe::request;
