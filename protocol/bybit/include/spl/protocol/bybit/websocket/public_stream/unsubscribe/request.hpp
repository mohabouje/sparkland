...
namespace spl::reflect {
    ...
    template <>
    struct identifier<spl::protocol::bybit::websocket::public_stream::unsubscribe::request> {
        using value_type                = spl::protocol::bybit::websocket::public_stream::unsubscribe::request;
